...
default_config = {
    ...
    'p1_class': 'tethyscluster.tests.mytestplugin.SetupClass',
    'p1_param1': 23,
    'p1_param2': 'skidoo',
    'p2_class': 'tethyscluster.tests.mytestplugin.SetupClass2',
    'p2_param1': 'hello',
    'p2_param2': 'world',
    'p3_class': 'tethyscluster.tests.mytestplugin.SetupClass3',
    'p3_param1': 'bon',
    'p3_param2': 'jour',
