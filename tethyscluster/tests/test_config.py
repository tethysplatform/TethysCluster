...
from tethyscluster import tests
...
class TestTethysClusterConfig(tests.StarClusterTest):
    ...
    def test_plugins(self):
        ...
        assert p1_name == 'p1'
        assert p1_class == 'tethyscluster.tests.mytestplugin.SetupClass'
        assert p1.my_arg == '23'
        assert p1.my_other_arg == 'skidoo'
        assert p2_name == 'p2'
        setup_class2 = 'tethyscluster.tests.mytestplugin.SetupClass2'
        assert p2_class == setup_class2
        assert p2.my_arg == 'hello'
        assert p2.my_other_arg == 'world'
        assert p3_name == 'p3'
        setup_class3 = 'tethyscluster.tests.mytestplugin.SetupClass3'
