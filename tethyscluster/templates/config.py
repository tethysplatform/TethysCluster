...
config_template = """\
####################################
## TethysCluster Configuration File ##
####################################
[global]
...
###########################
# Sections starting with "key" define your keypairs. See "tethyscluster createkey
...
#
#     $ tethyscluster start -c mediumcluster mycluster
#
...
# Use the 'listpublic' command to list TethysCluster AMIs in other regions
# The base i386 TethysCluster AMI is %(x86_ami)s
...
#############################
# TethysCluster can attach one or more EBS volumes to the master and then
...
# and configuring EBS volumes to be used with TethysCluster:
...
# By default TethysCluster will attempt first to mount the entire volume device,
...
#####################################
## Configuring TethysCluster Plugins ##
#####################################
# Sections starting with "plugin" define a custom python class which perform
# additional configurations to TethysCluster's default routines. These plugins
...
# [plugin myplugin]
# NOTE: myplugin module must either live in ~/.tethyscluster/plugins or be
# on your PYTHONPATH
...
## Built-in Plugins ##
######################
# The following plugins ship with TethysCluster and should work out-of-the-box.
...
# keys to $HOME/.tethyscluster/user_keys/<cluster>-<region>.tar.gz
# [plugin createusers]
# SETUP_CLASS = tethyscluster.plugins.users.CreateUsers
# NUM_USERS = 30
...
# details.
# [plugin sge]
# SETUP_CLASS = tethyscluster.plugins.sge.SGEPlugin
...
# [plugin ipcluster]
# SETUP_CLASS = tethyscluster.plugins.ipcluster.IPCluster
...
# [plugin tmux]
# SETUP_CLASS = tethyscluster.plugins.tmux.TmuxControlCenter
#
# Use this plugin to change the default MPI implementation on the
# cluster from OpenMPI to MPICH2.
# [plugin mpich2]
# SETUP_CLASS = tethyscluster.plugins.mpich2.MPICH2Setup
#
# Configure a hadoop cluster. (includes dumbo setup)
# [plugin hadoop]
# SETUP_CLASS = tethyscluster.plugins.hadoop.Hadoop
#
# Configure a distributed MySQL Cluster
# [plugin mysqlcluster]
# SETUP_CLASS = tethyscluster.plugins.mysql.MysqlCluster
# NUM_REPLICAS = 2
# DATA_MEMORY = 80M
# INDEX_MEMORY = 18M
# DUMP_FILE = test.sql
...
# [plugin xvfb]
# SETUP_CLASS = tethyscluster.plugins.xvfb.XvfbSetup
""" % {
