...
latex_documents = [
  (master_doc, 'TethysCluster.tex', u'TethysCluster Documentation',
...
man_pages = [
    (master_doc, 'TethysCluster', u'TethysCluster Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'TethysCluster', u'TethysCluster Documentation',
   author, 'TethysCluster', 'One line description of project.',
   'Miscellaneous'),
]
